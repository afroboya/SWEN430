...
public class UnionValidTests {
private static final String WHILE_SRC_DIR = "test_files/valid/unions/".replace('/', File.separatorChar);

	private final String testName;

	public UnionValidTests(String testName) {
