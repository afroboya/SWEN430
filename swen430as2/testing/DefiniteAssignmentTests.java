...
private static final String WHILE_SRC_DIR = "test_files/invalid/defassign/".replace('/', File.separatorChar);
	...
	private void runTest(String testname) throws IOException {
		...
		try {
			...
			assertTrue("Expected 'DA01' but found '" + code + "'", "DA01".equals(code));
