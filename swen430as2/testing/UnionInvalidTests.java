...
public class UnionInvalidTests {
private static final String WHILE_SRC_DIR = "test_files/invalid/unions/".replace('/', File.separatorChar);

	private final String testName;

	public UnionInvalidTests(String testName) {
