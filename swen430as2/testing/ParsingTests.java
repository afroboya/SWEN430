...
private static final String WHILE_SRC_DIR = "test_files/invalid/parsing/".replace('/', File.separatorChar);
	...
	private void runTest(String testname) throws IOException {
		...
		try {
			...
			String expected = testname.split("-").length > 1 ? testname.split("-")[1] : "";
			String code = e.code();
