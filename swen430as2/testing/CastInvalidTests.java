...
public class CastInvalidTests {
private static final String WHILE_SRC_DIR = "test_files/invalid/casts/".replace('/', File.separatorChar);

	private final String testName;

	public CastInvalidTests(String testName) {
