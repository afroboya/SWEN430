...
public class CastValidTests {
private static final String WHILE_SRC_DIR = "test_files/valid/casts/".replace('/', File.separatorChar);

	private final String testName;

	public CastValidTests(String testName) {
