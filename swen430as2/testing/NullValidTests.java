...
public class NullValidTests {
private static final String WHILE_SRC_DIR = "test_files/valid/null/".replace('/', File.separatorChar);

	private final String testName;

	public NullValidTests(String testName) {
