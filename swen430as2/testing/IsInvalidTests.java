...
public class IsInvalidTests {
private static final String WHILE_SRC_DIR = "test_files/invalid/is/".replace('/', File.separatorChar);

	private final String testName;

	public IsInvalidTests(String testName) {
