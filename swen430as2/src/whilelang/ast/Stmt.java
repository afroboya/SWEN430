...
public interface Stmt extends SyntacticElement {
	...
	public static final class Assert extends SyntacticElement.Impl implements
		...
		/**
		 * Get the expression whose value will determine with the assertion holds.
		 *
	...
	/**
	 * Represents a print statement which prints any value to the console.
	 *
	 * <pre>
	 * void f(int x) {
	 * 	print x;
	 ...
	 * </pre>
	 *
	 * @author Erin Greenwood-Thessman
	 *
	 */
	public static final class Print extends SyntacticElement.Impl implements
		...
		/**
		 * The expression which, when evaluated, will be printed.
		 */
		private final Expr expr;
