...
public class RealInvalidTests {
private static final String WHILE_SRC_DIR = "tests/invalid/real/".replace('/', File.separatorChar);

	private final String testName;

	public RealInvalidTests(String testName) {
