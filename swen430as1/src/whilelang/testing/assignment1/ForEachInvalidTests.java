...
public class ForEachInvalidTests {
private static final String WHILE_SRC_DIR = "tests/invalid/foreach/".replace('/', File.separatorChar);

	private final String testName;

	public ForEachInvalidTests(String testName) {
