...
public class DoWhileValidTests {
private static final String WHILE_SRC_DIR = "tests/valid/dowhile/".replace('/', File.separatorChar);

	private final String testName;

	public DoWhileValidTests(String testName) {
