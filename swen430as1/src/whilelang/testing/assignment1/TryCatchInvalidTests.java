...
public class TryCatchInvalidTests {
private static final String WHILE_SRC_DIR = "tests/invalid/trycatch/".replace('/', File.separatorChar);

	private final String testName;

	public TryCatchInvalidTests(String testName) {
