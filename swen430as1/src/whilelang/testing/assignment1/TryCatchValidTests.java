...
public class TryCatchValidTests {
private static final String WHILE_SRC_DIR = "tests/valid/trycatch/".replace('/', File.separatorChar);

	private final String testName;

	public TryCatchValidTests(String testName) {
