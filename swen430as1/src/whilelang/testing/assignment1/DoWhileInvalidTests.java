...
public class DoWhileInvalidTests {
private static final String WHILE_SRC_DIR = "tests/invalid/dowhile/".replace('/', File.separatorChar);

	private final String testName;

	public DoWhileInvalidTests(String testName) {
