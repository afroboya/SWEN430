...
public class TypeChecker {
	...
	public Type check(Expr.Binary expr, Map<String,Type> environment) {
		...
		case REM:
			...
			checkInstanceOf(leftType,expr.getLhs(),Type.Int.class,Type.Real.class);
			checkInstanceOf(rightType,expr.getRhs(),Type.Int.class,Type.Real.class);
			return leftType;
		case EQ:
		case NEQ:
	...
	public Type check(Expr.IndexOf expr, Map<String, Type> environment) {
		...
		checkInstanceOf(indexType, expr.getIndex(), Type.Int.class,Type.Real.class);
	...
	public Type check(Expr.ArrayGenerator expr, Map<String, Type> environment) {
		...
		checkInstanceOf(size,expr.getSize(),Type.Int.class,Type.Real.class);
	...
	private Type typeOf(Object constant, SyntacticElement elem) {
		if (constant instanceof Boolean) {
			...
			return new Type.Int();// why is this int?
	...
	public boolean isSubtype(Type t1, Type t2, SyntacticElement element) {
		if (t2 instanceof Type.Void) {
			...
			// OK//TODO might need to check this is correct later - havent figured out how to modify int to real
			return true;
